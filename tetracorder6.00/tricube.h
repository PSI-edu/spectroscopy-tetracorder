...
#ccc            
#ccc            scmask       mask for each pixel  = 0 do not analyze this pixel
#ccc            sctem        scene temperature for each pixel (Kelvin)
#ccc            sctemper     scene temperature (Kelvin) error for each pixel
#ccc            scpress      scene pressure for each pixel (bars)
#ccc            scpresserr   scene pressure error for each pixel (bars)
#ccc            
#ccc            
#ccc            
#ccc---------------------------------------------------------------
	...
	common /ctry1/ 	scmask, sctemp, sctemperr
	common /ctry1/  scpress, scpresserr
...
#	real*4          specdat(4852,1)   #extracted spectral sheet, BIP format
	...
	integer*4       scmask(maxpix)
	real*4		sctemp(maxpix), sctemperr(maxpix)
	real*4		scpress(maxpix), scpresserr(maxpix)
