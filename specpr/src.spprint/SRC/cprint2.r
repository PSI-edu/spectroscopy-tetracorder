...
#		call todms(iscta,24000,ihra,ihma,ss)
		...
		if (irwav < 0) irwav=0   # to reduce strange values
		...
		if (in!=1) {
			...
			if (mode2 != 1) {
				if (mode==0) {  # laboratory mode (default)
				     ...
				     write(ttyout,10)irecno,ititl,itchan,xptime,xpdate,irwav
					...
					if(ix1 > 0) {
						...
						write(ttyout,10)irecno,ititl,itchan,xptime,xpdate,irwav, irespt
					}
...
10 	format(I6,2x,a,1x,I5,2x,a,2x,a,1x,I6,1x,I6)
11 	format(I6,2x,a,1x,I5,2x,a,2x,a,a)
15	format(I6,2x,a,1x,I5,2x,a,2x,f6.3)
17	format(10x,a)	
20	format(5x,I6)
