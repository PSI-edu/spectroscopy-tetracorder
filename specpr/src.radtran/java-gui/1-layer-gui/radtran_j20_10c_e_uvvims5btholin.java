...
public class radtran_j20_10c_e_uvvims5btholin {
...
//   'Values' is an jradSliderFrame internal class
	...
	class Strout {
		//  print values to format output (to feed into Radtran)
                ...
                String[] cntrlstr = new String[101];
		...
		cntrlstr[7] = "R";
		cntrlstr[8] = "1";
		cntrlstr[9] = "V6                     \\# wavelengths to 0.1 - 6 micron 3800ch      3800";    
		cntrlstr[10] = "                      \\# deleted channels";
		cntrlstr[11] = "10                    \\# number of components";
...
// material 1
		iv = 0;
		cntrlstr[12] = "s                     \\# material 1";
		cntrlstr[13] = "v29                   \\# Iron (Fe) INDX REF Palik+Ordal 0.1-6um    3800";
		cntrlstr[14] = "v40                   \\# Iron (Fe) Palik+Ordal ABS COEF cm^-1 uv6  3800";
		...
		cntrlstr[15] = String.format("%10.7f  %10.7f  5  \\# gr up= .3-2um up", values[iv].current, values[iv+1].current);

		cntrlstr[16] = "\\##################";
// material 2
		iv = 2;
		cntrlstr[17] = "s                     \\# material 2";
		cntrlstr[18] = "v73                   \\# Triton Tholin INDXREF (dale Ore 3/2011)   3800";
		cntrlstr[19] = "v84                   \\# Triton Tholin ABSCOEF (Dale Ore 3/2011)   3800";
		cntrlstr[20] = String.format("%10.7f  %10.7f  5  \\# grain size in cm, abundance, density", values[iv].current, values[iv+1].current);
		cntrlstr[21] = "\\##################";
// material 3
// KEL 06/07/18		iv = 5;
                iv = 4;
		cntrlstr[22] = "f 2                   \\# material 3";
		cntrlstr[23] = "v117                  \\# nanoHematite2+0.03 CO2 INDX REF intrpuv1  3800       ";
		cntrlstr[24] = "v142                  \\# CO2 ICE, frm Warren INDX REF extraptoUV   3800       ";
		cntrlstr[25] = "v128   f              \\# nanoHematite2.5+0.03CO2+.1nFe ABS COEF e  3800       ";
...
// KEL 06/27/18		cntrlstr[27] = String.format("%10.7f  %10.7f  5  \\# grain size in cm, abundance, density", values[iv].current, values[iv+1].current);
		cntrlstr[26] = String.format("v153  %10.7f       \\# CO2 ice (Warren) ABS COEF extraptoUV      3800    ", values[iv].current);
		cntrlstr[27] = String.format("%10.7f  %10.7f  5  \\# grain size in cm, abundance, density", values[iv+1].current, values[iv+2].current);
		cntrlstr[28] = "\\##################";
// material 4
		iv = 7;
		cntrlstr[29] = "f 2                   \\# material 4";
		cntrlstr[30] = "v117                  \\# nanoHematite2+0.03 CO2 INDX REF intrpuv1  3800       ";
		cntrlstr[31] = "v142                  \\# CO2 ICE, frm Warren INDX REF extraptoUV   3800       ";
		cntrlstr[32] = "v128   f              \\# nanoHematite2.5+0.03CO2+.1nFe ABS COEF e  3800       ";  
		cntrlstr[33] = String.format("v153  %10.7f       \\# CO2 ice (Warren) ABS COEF extraptoUV   3800       ", values[iv].current);
		cntrlstr[34] = String.format("%10.7f  %10.7f  5  \\# grain size in cm, abundance, density", values[iv+1].current, values[iv+2].current);
		cntrlstr[35] = "\\##################";
// material 5
		iv = 10;
		cntrlstr[36] = "b 3                   \\# material 5";
		cntrlstr[37] = "v51                   \\# Cryst_H2O Ice INDX REF 120K intrp up uv6  3800";
		cntrlstr[38] = "v73                   \\# Triton Tholin INDXREF (dale Ore 3/2011)   3800";
		cntrlstr[39] = "v51                   \\# Cryst_H2O Ice INDX REF 120K intrp up uv6  3800       ";
		cntrlstr[40] = "v62    f              \\# Cryst_H2O Ice ABS COEF 120K intrpuv6 ed1  3800";
		cntrlstr[41] = String.format("v84   %10.7f       \\# Triton Tholin ABSCOEF (Dale Ore 3/2011)   3800", values[iv].current);
		cntrlstr[42] = String.format("v363  %10.7f       \\# D-O stretch inH2o 4.137efftv ABS COEF e3  3800    ", values[iv+1].current);
		cntrlstr[43] = String.format("%10.7f  %10.7f  1  \\# grain size in cm, abundance, density", values[iv+2].current, values[iv+3].current);
		cntrlstr[44] = "\\##################";
// material 6
		iv = 14;
		cntrlstr[45] = "b 3                   \\# material 6";
		cntrlstr[46] = "v51                   \\# Cryst_H2O Ice INDX REF 120K intrp up uv6  3800";
		cntrlstr[47] = "v73                   \\# Triton Tholin INDXREF (dale Ore 3/2011)   3800";
		cntrlstr[48] = "v51                   \\# Cryst_H2O Ice INDX REF 120K intrp up uv6  3800       ";
		cntrlstr[49] = "v62    f              \\# Cryst_H2O Ice ABS COEF 120K intrpuv6 ed1  3800";
		cntrlstr[50] = String.format("v84   %10.7f       \\# Triton Tholin ABSCOEF (Dale Ore 3/2011)   3800", values[iv].current);
		cntrlstr[51] = String.format("v363  %10.7f       \\# D-O stretch inH2o 4.137efftv ABS COEF e3  3800    ", values[iv+1].current);
		cntrlstr[52] = String.format("%10.7f  %10.7f  1  \\# grain size in cm, abundance, density", values[iv+2].current, values[iv+3].current);
		cntrlstr[53] = "\\##################";
// material 7
		iv = 18;
		cntrlstr[54] = "b 3                   \\# material 7";
		cntrlstr[55] = "v51                   \\# Cryst_H2O Ice INDX REF 120K intrp up uv6  3800";
		cntrlstr[56] = "v73                   \\# Triton Tholin INDXREF (dale Ore 3/2011)   3800";
		cntrlstr[57] = "v51                   \\# Cryst_H2O Ice INDX REF 120K intrp up uv6  3800       ";
		cntrlstr[58] = "v62    f              \\# Cryst_H2O Ice ABS COEF 120K intrpuv6 ed1  3800";
		cntrlstr[59] = String.format("v84   %10.7f       \\# Triton Tholin ABSCOEF (Dale Ore 3/2011)   3800", values[iv].current);
		cntrlstr[60] = String.format("v363  %10.7f       \\# D-O stretch inH2o 4.137efftv ABS COEF e3  3800    ", values[iv+1].current);
		cntrlstr[61] = String.format("%10.7f  %10.7f  1  \\# grain size in cm, abundance, density", values[iv+2].current, values[iv+3].current);
		cntrlstr[62] = "\\##################";

// material 8
		iv = 22;
		cntrlstr[63] = "b 3                   \\# material 8";
		cntrlstr[64] = "v51                   \\# Cryst_H2O Ice INDX REF 120K intrp up uv6  3800";
		cntrlstr[65] = "v73                   \\# Triton Tholin INDXREF (dale Ore 3/2011)   3800";
		cntrlstr[66] = "v51                   \\# Cryst_H2O Ice INDX REF 120K intrp up uv6  3800       ";
		cntrlstr[67] = "v62    f              \\# Cryst_H2O Ice ABS COEF 120K intrpuv6 ed1  3800";
		cntrlstr[68] = String.format("v84   %10.7f       \\# Triton Tholin ABSCOEF (Dale Ore 3/2011)   3800", values[iv].current);
		cntrlstr[69] = String.format("v363  %10.7f       \\# D-O stretch inH2o 4.137efftv ABS COEF e3  3800    ", values[iv+1].current);
		cntrlstr[70] = String.format("%10.7f  %10.7f  1  \\# grain size in cm, abundance, density", values[iv+2].current, values[iv+3].current);
		cntrlstr[71] = "\\##################";

// material 9
		iv = 26;
		cntrlstr[72] = "b 3                   \\# material 9";
		cntrlstr[73] = "v51                   \\# Cryst_H2O Ice INDX REF 120K intrp up uv6  3800";
		cntrlstr[74] = "v73                   \\# Triton Tholin INDXREF (dale Ore 3/2011)   3800";
		cntrlstr[75] = "v51                   \\# Cryst_H2O Ice INDX REF 120K intrp up uv6  3800       ";
		cntrlstr[76] = "v62    f              \\# Cryst_H2O Ice ABS COEF 120K intrpuv6 ed1  3800";
		cntrlstr[77] = String.format("v84   %10.7f       \\# Triton Tholin ABSCOEF (Dale Ore 3/2011)   3800", values[iv].current);
		cntrlstr[78] = String.format("v363  %10.7f       \\# D-O stretch inH2o 4.137efftv ABS COEF e3  3800    ", values[iv+1].current);
		cntrlstr[79] = String.format("%10.7f  %10.7f  1  \\# grain size in cm, abundance, density", values[iv+2].current, values[iv+3].current);
		cntrlstr[80] = "\\##################";

// material 10
		iv = 30;
		cntrlstr[81] = "b 3                   \\# material 10";
		cntrlstr[82] = "v51                   \\# Cryst_H2O Ice INDX REF 120K intrp up uv6  3800";
		cntrlstr[83] = "v29                   \\# Iron (Fe) INDX REF Palik+Ordal 0.1-6um    3800";
		cntrlstr[84] = "v51                   \\# Cryst_H2O Ice INDX REF 120K intrp up uv6  3800       ";
		cntrlstr[85] = "v62    f              \\# Cryst_H2O Ice ABS COEF 120K intrpuv6 ed1  3800";
		cntrlstr[86] = String.format("v84   %10.7f       \\# Triton Tholin ABSCOEF (Dale Ore 3/2011)   3800", values[iv].current);
		cntrlstr[87] = String.format("v363  %10.7f       \\# D-O stretch inH2o 4.137efftv ABS COEF e3  3800    ", values[iv+1].current);
		cntrlstr[88] = String.format("%10.7f  %10.7f  1  \\# grain size in cm, abundance, density", values[iv+2].current, values[iv+3].current);
		cntrlstr[89] = "\\##################";

		cntrlstr[90] = " 0 20 20              \\# placeholder for spherical albedo";
		cntrlstr[91] = "y";
		cntrlstr[92] = "                      \\# s value";
		cntrlstr[93] = "                      \\# wavelength dependent scattering";
		cntrlstr[94] = "                      \\# no nf";
		cntrlstr[95] = "0 \\# 2               \\# FUTURE, IF NEEDED";
		cntrlstr[96] = "\\# d1306   0.00001   \\# FUTURE, NEED 1023ch: 6C.01nFe.02Fe.917HemnFe.04nHnFe.H2O+CO2    352";
		cntrlstr[97] = "\\# d1312   0.00001   \\# FUTURE, NEED 1023ch: H2Oice+nFe+nHem mol mix+areal.1 10CMPREF   352";
		cntrlstr[98] = "\\#       1111111111222222222233333333334";
		cntrlstr[99] = "\\#34567890123456789012345678901234567890";
		cntrlstr[100] = String.format("10-component radtran, set title here     w%8.5f %8.5f %8.5f %8.5f",
