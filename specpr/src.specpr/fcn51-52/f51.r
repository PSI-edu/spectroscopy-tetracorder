...
#ccc  name:  f42
#ccc  version date:  June 1 - October 21, 2013
#ccc  author(s):  Roger N. Clark
#ccc  language:  Ratfor
#ccc
#ccc  short description: 
#ccc		This program fits a cubic spline continuum to a
#ccc            spectrum over a spectral feature using 
#ccc            4 wavelength intervals defined by the user.
#ccc
