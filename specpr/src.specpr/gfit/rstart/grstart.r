...
1000    continue
	...
	else call setfil(18,irfl,20480)
	define file 18(1,1024,u,ifv18)
	call dread(18,3,1024,istart,ier)
	if (ier.ne.0) goto 1234
...
1                       format(80a1)
	...
	endfile 16
	call setfil(16,'.cmd',20480)
	define file 16(1,80,u,ifv16)
#
#     assign wavelength file
#
	call setfil(11,'.spwav',20480)
	define file 11(1,1024,u,ifv11)
#
#      assign wavelength header file
#
	call setfil(14,'.wvhed',20480)
	define file 14(1,514,u,ifv14)
#
#     assign title file
#
	call setfil(15,'.spttl',20480)
	define file 15(1,128,u,ifv15)
#
#     assign device v
#
	call setfil(8,ivfl,20480)
	define file 8(1,1536,u,ifv08)
#
#     assign device w
#
	call setfil(9,iwfl,20480)
	define file 9(1,1536,u,ifv09)
#
#     assign device d
#
	call setfil(7,idfl,20480)
	define file 7(1,1536,u,ifv07)
#
#     assign starpack file =s
#
	call setfil(17,isfl,20480)
	define file 17(1,2048,u,ifv17)
#
#     assign device u
#
	call setfil(3,iufl,20480)
	define file 3(1,1536,u,ifv03)
#
#     assign device y
#
	call setfil(4,iyfl,20480)
	define file 4(1,1536,u,ifv04)
#
