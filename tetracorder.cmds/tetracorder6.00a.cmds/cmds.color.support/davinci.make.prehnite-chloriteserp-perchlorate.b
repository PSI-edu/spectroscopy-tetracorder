...
a =a+ read_an_image("group.2um/chlorite_clinochlore.nmnh83369.fd.gif")
a =a+ read_an_image("group.2um/chlorite_clinochlore.fe.gds157.fd.gif")
a =a+ read_an_image("group.2um/chlorite_clinochlore.fe.sc-cca-1.fd.gif")
a =a+ read_an_image("group.2um/chlorite_cookeite-car-1.a.fd.gif")
a =a+ read_an_image("group.2um/chlorite_cookeite-car-1.c.fd.gif")
